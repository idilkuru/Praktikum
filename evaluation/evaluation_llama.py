...
with open("../Data/merged_dataset_1800_spa.jsonl", "r", encoding="utf-8") as f:
...
# Processing and normalizing labels
for pred_entry in pred_data:
    ...
    # Normalizing gold labels
    gold = [l if l != "named_entity" else "other" for l in gold_entry["labels_unified"]]
    # Normalizing predicted labels
    pred = [l if l == "oth" else l for l in pred_entry["predicted_labels"]]
